...
public class PullToZoomListView extends ListView implements
    ...
    public void onScroll(AbsListView paramAbsListView, int paramInt1,
        ...
        Log.d("mmm", this.mHeaderHeight + "高度" + mHeaderContainer.getBottom());
        Log.d("mmm", mHeaderImage.getScrollY() + "");
        if ((f > 0.0F) && (f+10 < this.mHeaderHeight)) {
            int i = (int) (0.65D * f);
            this.mHeaderImage.scrollTo(0, -i);
            Log.d("mmm", "_____________________________________________" + i);
        } else if (this.mHeaderImage.getScrollY() != 0) {
            Log.d("mmm", "__________________________________复原");
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent) {
        Log.d("mmm", "" + (MotionEvent.ACTION_MASK & paramMotionEvent.getAction()));
